...
// Modal Group M8: Drill control
#define DRILL_DISABLE 0 // M9 (Default: Must be zero)
#define DRILL_FLOOD_ENABLE  PL_COND_FLAG_DRILL_FLOOD // M8 (NOTE: Uses planner condition bit flag)
#define DRILL_MIST_ENABLE   PL_COND_FLAG_DRILL_MIST  // M7 (NOTE: Uses planner condition bit flag)
